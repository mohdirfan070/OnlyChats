...
export default function Login() {
  ...
  return (
    <div className="fixed top-[50%] left-[50%]  translate-x-[-50%] translate-y-[-50%] text-3xl text-prime m-auto border-[0.032rem] bg-linear-to-b from-backform from-80% to-frontform  min-w-full  max-w-[32rem] h-[22rem]  p-[2rem] rounded-lg  ">
                <h1 className="text-center font-semibold underline mb-2" >User Login</h1>
               <p className=" text-center text-[3vh]" >New here? <Link  to={"/signup"} className=" text-center text-[2.51vh] text-blue-500 hover:underline" >Click to Register</Link></p>
